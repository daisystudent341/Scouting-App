...
camera = CameraQRGUI()
dataHandler = DataHandler("pass.txt")

q = queue.Queue()

try:
    with open('offline_buffer.pkl', 'rb') as f:
        loaded_dict_arr = pickle.load(f)
except FileNotFoundError:
    with open('offline_buffer.pkl', 'wb') as f:
        pickle.dump(set(), f)
...
if __name__ == "__main__":
    loaded_dict_arr.add(str("99,99"))
    print(loaded_dict_arr)
